...
function Explore() {
  const artist = [
    {
      name: "M TP",
      image: "https://media-cdn-v2.laodong.vn/Storage/NewsPortal/2021/2/23/882785/Son-Tung-Mtp.jpeg",
    },
    {
      name: "AMEE",
    ...
    {
      name: "7dnight",
      image: "https://static.wixstatic.com/media/41a9b2_0c708f6344c84434839a9c4002a07a2b~mv2.png/v1/fill/w_980,h_980,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/41a9b2_0c708f6344c84434839a9c4002a07a2b~mv2.png",
    },
    {
      name: "Den",
      image: "https://thanhnien.mediacdn.vn/uploaded/hienht/2021_04_12/den-vau_TICF.jpg?width=500",
    },
  ];
    ...
    <DefaultTemplate>
      <div className="w-full min-h-screen items-center justify-center">
        ...
        <div className="container mx-auto flex flex-wrap">
          {genres.map((genre) => (
            <div className="card w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-4">
              <img
                src={genre.image}
                alt={genre.name}
