        ...
        <div className="w-4/5 mx-auto">
          ...
          <div className="pt-4">
            ...
            <button
              ...
              class="flex w-full justify-center py-3 items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
            >
              <svg
                class="h-6 w-6 mr-2"
