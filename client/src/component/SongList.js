...
export default function SongList({ url }) {
  ...
  const isPlaylistScreen = location.pathname === '/playlist/playlistId';
    ...
    <div className="w-full flex items-center mt-5">
      ...
      <div>
        ...
        >
          ...
          <MenuItem style={{ display: isPlaylistScreen ? 'block' : 'none' }}>
            <ListItemIcon>
              <FaRegHeart
                className="text-light10 dark:text-dark10 mt-1"
                size={18}
              />
              <ListItemText>&nbsp;Delete to playlist</ListItemText>
            </ListItemIcon>
          </MenuItem>
