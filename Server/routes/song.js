...
songRouter.get(
  "/recentSong",
  verifyToken,
  SongController.getRecentlyPlayedSongs
);
...
songRouter.get(
  ...
  SongController.getPopularSongOfArtist
);
...
songRouter.post(
  "/favourited/:songId",
  verifyToken,
  SongController.favouritedSong
);
songRouter.get("/getHotestSong", SongController.getSongsByLastest);
songRouter.get("/getLatest/:limit/:songType", SongController.getLatestSongs);
songRouter.get(
  "/getSongByGenre/:limit/:genreId/:songType",
  SongController.getSongByGenre
);
songRouter.get("/checkFavorite/:songId", SongController.checkFavouriteSong);
songRouter.get(
  "/filterSongByArtist/:date/:sort",
  verifyToken,
  SongController.getFilterSongByArtist
);
songRouter.post(
  "/disableEnableSong",
  verifyToken,
  SongController.disableEnableSong
);
